...
def topic_background(topic_key: str) -> str:
    ...
    Everything about what was collected and why lives here, not in the
    analysis prompts. Project-specific private backgrounds can be supplied
    from a non-public checkout or downstream integration rather than being
