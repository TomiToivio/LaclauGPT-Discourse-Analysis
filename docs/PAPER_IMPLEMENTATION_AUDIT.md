...
| Batch interchange | `laclaugpt_interchange/` | Current schema **1.5** (1.4: descriptive `SentimentObservation`; 1.3: `MemoryRef.ner_type`; version lives in `laclaugpt_interchange.SCHEMA_VERSION` — do not hard-code it here) |
