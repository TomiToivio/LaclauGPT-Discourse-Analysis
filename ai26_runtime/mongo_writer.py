# -*- coding: utf-8 -*-
"""AI26 canonical writer: CollectRecord-shaped dicts -> MongoDB (laclaugpt_ai26.ai26_*).
...
def _mongo_uri() -> str:
    # private config holds the URI with the configured deployment credential
